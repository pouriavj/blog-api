...
app.post("/posts", (req, res) => {
  ...
  posts.push({ id : posts.length + 1 , title: req.body.title , content: req.body.content , author: req.body.author , date: dateString.toISOString() });
  res.sendStatus(200);
});
...
app.patch("/posts/:id", (req, res) =>{
  ...
  if (!posts[searchIndex]) return res.status(404).json({ message: "Post not found" });
  if (req.body.title){
